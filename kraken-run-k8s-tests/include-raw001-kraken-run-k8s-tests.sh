...
export KUBE_ROOT=/var/lib/docker/gobuild/${KUBE_CONFORMANCE_DIR}
...
KUBE_CONFORMANCE_LOG=/var/lib/docker/gobuild/${KUBE_CONFORMANCE_DIR}/kraken_${GIT_COMMIT}_conformance.log
